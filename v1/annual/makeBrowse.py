    ...
    if not os.path.exists(pngFile):
      ...
      try:
        ...
        with open("errorLOG.txt", 'a') as ERR:
          ERR.write("could not delete, no file found "+tmpTif+" "+str(datetime.datetime.now())+"\n")
      try:
        os.system("rm "+pngFile+".aux.xml")
      except:
        with open("errorLOG.txt", 'a') as ERR:
          ERR.write("could not delete, no file found "+pngFile+".aux.xml "+str(datetime.datetime.now())+"\n")
  except:
    with open("errorLOG.txt", 'a') as ERR:
