...
if __name__=='__main__':
  ...
  response = subprocess.run(["ssh gladapp17 \'cd "+currdir+"; g++ 03Atest.cpp -o 03A_alertUpdateVEG -lgdal -std=gnu++11 -Wno-unused-result\'"],shell=True)
  ...
  serverlist =  [(14,20),(15,20)]#,(18,30)]#[(17,60),(16,40),(15,40),(14,40)]
  processes = []
